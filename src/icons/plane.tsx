...
interface PlaneIconProps extends React.SVGProps<SVGSVGElement> { action?: "landing" | "takeoff" }

export const PlaneIcon: React.FC<PlaneIconProps> = ({ action = "landing" }) => {
    const angle =
        action === "landing" ? "rotate(5 150 150)" : "rotate(-30 150 150)";
