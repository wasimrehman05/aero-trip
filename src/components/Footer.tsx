...
export function Footer() {
    return (
        <footer className="bg-gray-900 text-white footer">
            <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-10 py-6">
                <div className="flex justify-between w-full px-2">
                    <div className="basis-[25%]">
                        ...
                        <p className="text-gray-400">
                            ...
                            deals and making your travel dreams come true.
                        </p>
                    </div>
                    <div>
                        <h3 className="text-lg font-semibold mb-4">
                ...
                <div className="mt-6 border-t border-gray-800 pt-4 text-center text-gray-400">
                    <p>
                        &copy; {new Date().getFullYear()} AeroTrip. All rights
                        reserved.
                    </p>
                </div>
            </div>
